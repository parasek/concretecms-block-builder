...
<div class="bb-custom-code mb-4 <?= h(in_array('registerViewAssetsCustomCode', $fieldsWithError) ? 'bb-has-error' : null); ?>">
    <?= $form->label('registerViewAssetsCustomCode', t('Custom code inside the registerViewAssets() method')); ?>
...
<div class="bb-custom-code mb-4 <?= h(in_array('viewCustomCode', $fieldsWithError) ? 'bb-has-error' : null); ?>">
    <?= $form->label('viewCustomCode', t('Custom code inside the view() method')); ?>
...
<div class="bb-custom-code mb-4 <?= h(in_array('excludedFromRemoval', $fieldsWithError) ? 'bb-has-error' : null); ?>">
    ...
    <div class="form-text">
        ...
        <br>
        <?= t('Each file or folder path should be relative to the directory containing controller.php (for example: templates) and placed on a new line.'); ?>
    </div>
</div>
