...
final readonly class BlockFormFieldLabelProvider
{
    public function getLabel(string $fieldHandle): string
    {
        return match ($fieldHandle) {
            ...
            'cacheBlockOutputOnPost' => t('Cache block output for POST requests'),
            ...
            'installBlock' => t('Install the block type after creation'),
            'entriesAsFirstTab' => t('Show the "Entries" tab first'),
            'maxNumberOfEntries' => t('Maximum number of entries'),
            'highlightMultiElementFields' => t('Highlight fields with multiple inputs'),
            ...
            'excludedFromRemoval' => t('Files and folders excluded when rebuilding the block'),
            ...
            'maxNumberOfEntriesLabel' => t('Maximum number of entries'),
            'removeEntryLabel' => t('Remove entry'),
            'duplicateEntryLabel' => t('Duplicate entry'),
            'duplicateEntryAndAddAtTheEndLabel' => t('Duplicate entry at the end'),
            'areYouSureLabel' => t('Are you sure?'),
            'requiredFieldsLabel' => t('Required fields'),
            'urlEndingLabel' => t('Custom string at the end of the URL'),
            ...
            'noFollowLabel' => t('Add the nofollow attribute'),
            'yesLabel' => t('Yes'),
            'noLabel' => t('No'),
            ...
            'titleSource' => t('Use this field as the title in repeatable entries'),
            ...
            'datePattern' => t('PHP date format'),
            'minDate' => t('Minimum date'),
            'maxDate' => t('Maximum date'),
            'attachTimeSelector' => t('Enable time selection'),
            ...
            'showEndingField' => t('Show the "Custom string at the end of the URL" field'),
            ...
            'showNoFollowField' => t('Show the "Add the nofollow attribute" field'),
            ...
            'size' => t('Database precision and scale'),
            'step' => t('Step'),
            'minimum' => t('Minimum'),
            'maximum' => t('Maximum'),
