...
PHP;
    ...
    private function renderFormFragment(FieldGenerationContext $context): string
    {
        ...
        $replacements = [
            ...
            '{{ENDING_LABEL_LITERAL}}' => $this->formatLabel($config->urlEndingLabel, 'Custom string at the end of the URL'),
            ...
            '{{NO_FOLLOW_LABEL_LITERAL}}' => $this->formatLabel($config->noFollowLabel, 'Add the nofollow attribute'),
