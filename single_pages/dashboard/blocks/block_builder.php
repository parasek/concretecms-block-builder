    ...
    <form method="post" action="<?= $formAction; ?>">
        ...
        <div class="ccm-tab-content" id="ccm-tab-content-texts" style="display: none;">
            ...
            <div class="mb-4 populate-translation-fields">
                ...
                or
                <a href="#" class="js-populate-translation-fields" data-type="untranslated"><?= t('untranslated'); ?></a>
                <?= t('default texts'); ?>
            </div>
        ...
        <div class="ccm-tab-content" id="ccm-tab-content-tab-basic-information" style="display: none;">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 mb-4 entries-actions d-flex flex-column flex-md-row align-items-md-center">
                    ...
                    <a href="#" class="entries-action js-expand-all"><i class="far fa-plus-square"></i> <?= t('Expand all'); ?></a>
                    <a href="#" class="entries-action js-collapse-all"><i class="far fa-minus-square"></i> <?= t('Collapse all'); ?></a>
                    <a href="#" class="entries-action entries-action-remove-all js-remove-all" data-group-handle="basic" data-confirm-text="<?= t('Are you sure?'); ?>"><i class="fas fa-times-circle"></i> <?= t('Remove all'); ?></a>
                </div>
            </div>
        ...
        <div class="ccm-tab-content" id="ccm-tab-content-tab-repeatable-entries" style="display: none;">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 mb-4 entries-actions d-flex flex-column flex-md-row align-items-md-center">
                    ...
                    <a href="#" class="entries-action js-expand-all"><i class="far fa-plus-square"></i> <?= t('Expand all'); ?></a>
                    <a href="#" class="entries-action js-collapse-all"><i class="far fa-minus-square"></i> <?= t('Collapse all'); ?></a>
                    <a href="#" class="entries-action entries-action-remove-all js-remove-all" data-group-handle="entries" data-confirm-text="<?= t('Are you sure?'); ?>"><i class="fas fa-times-circle"></i> <?= t('Remove all'); ?></a>
                </div>
            </div>
    ...
    <script type="text/template" class="js-template-entries">
        ...
        <div class="well entry js-entry <% if (error) { %>entry-has-error<% } %>" data-counter="<%=counter%>">
            ...
            <div class="entry-header">
                <div class="entry-header-action entry-header-remove-entry js-remove-entry" data-confirm-text="<?= t('Are you sure?'); ?>"><i class="fas fa-times"></i></div>
            ...
            <div class="entry-content js-entry-content">
                ...
                <div class="row">
                    <div class="col-lg-6 mb-4 <% if (error['label']!=undefined) { %>has-error<% } %>">
                        <label for="<%=groupHandle%>[<%=counter%>][label]" class="form-label"><?= t('Label'); ?> *</label>
                        <input type="text"
                    ...
                    <div class="col-lg-6 mb-4 <% if (error['handle']!=undefined) { %>has-error<% } %>">
                        <label for="<%=groupHandle%>[<%=counter%>][handle]" class="form-label"><?= t('Handle'); ?> *</label>
                        <input type="text"
                ...
                <div class="row">
                    <div class="col-lg-6 mb-4">
                        <div class="form-check">
                            ...
                            >
                            <label for="<%=groupHandle%>[<%=counter%>][required]" class="form-check-label"><?= t('Required'); ?></label>
                        </div>
                        ...
                        <div class="form-check">
                            ...
                            >
                            <label for="<%=groupHandle%>[<%=counter%>][titleSource]" class="form-check-label"><?= t('Use this field as title in repeatable entries'); ?></label>
                        </div>
                        <% } %>
                    </div>
                    <div class="col-lg-6 mb-4">
                        <label for="<%=groupHandle%>[<%=counter%>][helpText]" class="form-label"><?= t('Help text'); ?></label>
                        <input type="text"
                    ...
                    <div class="mb-0">
                        ...
                        <div class="mb-4 <% if (error['numberSize']!=undefined) { %>has-error<% } %>">
                            <label for="<%=groupHandle%>[<%=counter%>][numberSize]" class="form-label"><?= t('Size'); ?></label>
                            <input type="text"
                        ...
                        <div class="mb-4 <% if (error['numberStep']!=undefined) { %>has-error<% } %>">
                            <label for="<%=groupHandle%>[<%=counter%>][numberStep]" class="form-label"><?= t('Step'); ?></label>
                            <input type="text"
                        ...
                        <div class="mb-4 <% if (error['numberMin']!=undefined) { %>has-error<% } %>">
                            <label for="<%=groupHandle%>[<%=counter%>][numberMin]" class="form-label"><?= t('Minimum'); ?></label>
                            <input type="text"
                        ...
                        <div class="mb-4 <% if (error['numberMax']!=undefined) { %>has-error<% } %>">
                            <label for="<%=groupHandle%>[<%=counter%>][numberMax]" class="form-label"><?= t('Maximum'); ?></label>
                            <input type="text"
                        ...
                        <div class="mb-4 <% if (error['numberDisplayedDecimals']!=undefined) { %>has-error<% } %>">
                            <label for="<%=groupHandle%>[<%=counter%>][numberDisplayedDecimals]" class="form-label"><?= t('Displayed decimals'); ?></label>
                            <input type="number"
                        ...
                        <div class="mb-4 <% if (error['numberDisplayedDecimalSeparator']!=undefined) { %>has-error<% } %>">
                            <label for="<%=groupHandle%>[<%=counter%>][numberDisplayedDecimalSeparator]" class="form-label"><?= t('Displayed decimal separator'); ?></label>
                            <input type="text"
                        ...
                        <div class="<% if (error['numberDisplayedThousandsSeparator']!=undefined) { %>has-error<% } %>">
                            <label for="<%=groupHandle%>[<%=counter%>][numberDisplayedThousandsSeparator]" class="form-label"><?= t('Displayed thousands separator'); ?></label>
                            <input type="text"
                        ...
                        <div class="<% if (error['textareaHeight']!=undefined) { %>has-error<% } %>">
                            <label for="<%=groupHandle%>[<%=counter%>][textareaHeight]" class="form-label"><?= t('Height'); ?></label>
                            <div class="col-lg-3">
                                <div class="input-group">
                                    <input type="text"
                        ...
                        <div class="<% if (error['wysiwygEditorHeight']!=undefined) { %>has-error<% } %> mb-4">
                            <label for="<%=groupHandle%>[<%=counter%>][wysiwygEditorHeight]" class="form-label"><?= t('Height'); ?></label>
                            <div class="col-lg-3">
                                <div class="input-group">
                                    <input type="text"
                            ...
                            <div class="form-text"><?= t('Default height of editable area: %s.', '40px'); ?><br/><?= t('Editor auto-grow will be enabled if you leave this field empty.'); ?></div>
                        </div>

                        <div class="<% if (error['wysiwygCustomConfig']!=undefined) { %>has-error<% } %>">
                            <label for="<%=groupHandle%>[<%=counter%>][wysiwygCustomConfig]" class="form-label"><?= t('Custom editor config'); ?></label>
  ...
  "toolbar": [
    ...
    },
    {
      ...
      "items": ["Styles", "Format"]
                        ...
                        <div class="mb-4">
                            <label for="<%=groupHandle%>[<%=counter%>][selectType]" class="form-label"><?= t('Type'); ?></label>
                            <select name="<%=groupHandle%>[<%=counter%>][selectType]"
                                    id="<%=groupHandle%>[<%=counter%>][selectType]"
                                    class="form-select"
                            >
                                <?php foreach ($selectFieldTypes as $k => $v): ?>
                                    <option value="<?= h($k); ?>" <% if (selectType === '<?= h($k); ?>') { %>selected<% } %>><?= h($v); ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="mb-4">
                            <label for="<%=groupHandle%>[<%=counter%>][selectAddEmptyOption]" class="form-label"><?= t('Add empty option'); ?></label>
                        ...
                        <div class="mb-4">
                            <label for="<%=groupHandle%>[<%=counter%>][selectDefaultValue]" class="form-label"><?= t('Default value'); ?></label>
                            <input type="text"
                        ...
                        <div class="mb-4">
                            <label for="<%=groupHandle%>[<%=counter%>][selectListGenerationMethod]" class="form-label"><?= t('List generation method'); ?></label>
                            ...
                            >
                                <?php foreach ($selectFieldListGenerationMethods as $k => $v): ?>
                                    <option value="<?= h($k); ?>" <% if (selectListGenerationMethod === '<?= h($k); ?>') { %>selected<% } %>><?= h($v); ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="<% if (error['selectOptions']!=undefined) { %>has-error<% } %>">
                            ...
                            >
                                <div class="mb-4">
                                    <label for="<%=groupHandle%>[<%=counter%>][selectOptions]" class="form-label"><?= t('Select options'); ?></label>
                            ...
                            <div data-select-list-generation-method="custom_code"
                                 ...
                                 <% } %>
                            >
                                <label for="<%=groupHandle%>[<%=counter%>][selectCustomCode]" class="form-label"><?= t('Custom code'); ?></label>
                        ...
                        <div class="mb-4">
                            <label for="<%=groupHandle%>[<%=counter%>][selectMultipleType]" class="form-label"><?= t('Type'); ?></label>
                            ...
                            >
                                <?php foreach ($selectMultipleFieldTypes as $k => $v): ?>
                                    <option value="<?= h($k); ?>" <% if (selectMultipleType === '<?= h($k); ?>') { %>selected<% } %>><?= h($v); ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="mb-4">
                            <label for="<%=groupHandle%>[<%=counter%>][selectMultipleDefaultValue]" class="form-label"><?= t('Default value'); ?></label>
                            <input type="text"
                        ...
                        <div class="mb-4">
                            <label for="<%=groupHandle%>[<%=counter%>][selectMultipleListGenerationMethod]" class="form-label"><?= t('List generation method'); ?></label>
                            ...
                            >
                                <?php foreach ($selectFieldListGenerationMethods as $k => $v): ?>
                                    <option value="<?= h($k); ?>" <% if (selectMultipleListGenerationMethod === '<?= h($k); ?>') { %>selected<% } %>><?= h($v); ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="<% if (error['selectMultipleOptions']!=undefined) { %>has-error<% } %>">
                            <div data-select-list-generation-method="basic_list"
                                 ...
                                 <% } %>
                            >
                                <label for="<%=groupHandle%>[<%=counter%>][selectMultipleOptions]" class="form-label"><?= t('Select options'); ?></label>
                                <p class="small text-muted">
                                    <?= t('Enter every option in new line, e.g.'); ?>
                                    <code class="bb-code-block">
                                        <?= t('Don\'t show'); ?>
                            ...
                            <div data-select-list-generation-method="custom_code"
                                 ...
                                 <% } %>
                            >
                                <label for="<%=groupHandle%>[<%=counter%>][selectMultipleCustomCode]" class="form-label"><?= t('Custom code'); ?></label>
                                <?php View::element('custom_code_in_option_list', [], 'block_builder'); ?>
                        ...
                        <div class="form-check">
                            ...
                            >
                            <label for="<%=groupHandle%>[<%=counter%>][linkFromSitemapShowEndingField]" class="form-check-label"><?= t('Show "Custom string at the end of URL" field'); ?></label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox"
                                   class="form-check-input"
                            ...
                            >
                            <label for="<%=groupHandle%>[<%=counter%>][linkFromSitemapShowTextField]" class="form-check-label"><?= t('Show "Text" field'); ?></label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox"
                                   class="form-check-input"
                            ...
                            >
                            <label for="<%=groupHandle%>[<%=counter%>][linkFromSitemapShowTitleField]" class="form-check-label"><?= t('Show "Title" field'); ?></label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox"
                                   class="form-check-input"
                            ...
                            >
                            <label for="<%=groupHandle%>[<%=counter%>][linkFromSitemapShowNewWindowField]" class="form-check-label"><?= t('Show "Open in new window" field'); ?></label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox"
                                   class="form-check-input"
                            ...
                            >
                            <label for="<%=groupHandle%>[<%=counter%>][linkFromSitemapShowNoFollowField]" class="form-check-label"><?= t('Show "Add nofollow attribute" field'); ?></label>
                        </div>
                        <% } %>
                        ...
                        <div class="form-check">
                            ...
                            >
                            <label for="<%=groupHandle%>[<%=counter%>][linkFromFileManagerShowEndingField]" class="form-check-label"><?= t('Show "Custom string at the end of URL" field'); ?></label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox"
                                   class="form-check-input"
                            ...
                            >
                            <label for="<%=groupHandle%>[<%=counter%>][linkFromFileManagerShowTextField]" class="form-check-label"><?= t('Show "Text" field'); ?></label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox"
                                   class="form-check-input"
                            ...
                            >
                            <label for="<%=groupHandle%>[<%=counter%>][linkFromFileManagerShowTitleField]" class="form-check-label"><?= t('Show "Title" field'); ?></label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox"
                                   class="form-check-input"
                            ...
                            >
                            <label for="<%=groupHandle%>[<%=counter%>][linkFromFileManagerShowNewWindowField]" class="form-check-label"><?= t('Show "Open in new window" field'); ?></label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox"
                                   class="form-check-input"
                            ...
                            >
                            <label for="<%=groupHandle%>[<%=counter%>][linkFromFileManagerShowNoFollowField]" class="form-check-label"><?= t('Show "Add nofollow attribute" field'); ?></label>
                        </div>
                        <% } %>
                        ...
                        <div class="form-check">
                            ...
                            >
                            <label for="<%=groupHandle%>[<%=counter%>][externalLinkShowEndingField]" class="form-check-label"><?= t('Show "Custom string at the end of URL" field'); ?></label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox"
                                   class="form-check-input"
                            ...
                            >
                            <label for="<%=groupHandle%>[<%=counter%>][externalLinkShowTextField]" class="form-check-label"><?= t('Show "Text" field'); ?></label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox"
                                   class="form-check-input"
                            ...
                            >
                            <label for="<%=groupHandle%>[<%=counter%>][externalLinkShowTitleField]" class="form-check-label"><?= t('Show "Title" field'); ?></label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox"
                                   class="form-check-input"
                            ...
                            >
                            <label for="<%=groupHandle%>[<%=counter%>][externalLinkShowNewWindowField]" class="form-check-label"><?= t('Show "Open in new window" field'); ?></label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox"
                                   class="form-check-input"
                            ...
                            >
                            <label for="<%=groupHandle%>[<%=counter%>][externalLinkShowNoFollowField]" class="form-check-label"><?= t('Show "Add nofollow attribute" field'); ?></label>
                        </div>
                        <% } %>
                        ...
                        <div class="form-check">
                            ...
                            >
                            <label for="<%=groupHandle%>[<%=counter%>][imageShowAltTextField]" class="form-check-label"><?= t('Show "Alt text" field'); ?></label>
                        </div>
                        ...
                        <div class="col-lg-4 mb-4 <% if (error['imageThumbnailHeight']!=undefined) { %>has-error<% } %>">
                            <label for="<%=groupHandle%>[<%=counter%>][imageThumbnailHeight]" class="form-label"><?= t('Height'); ?></label>
                            <div class="input-group">
                                <input type="text"
                        ...
                        <div class="col-lg-2 mb-4">
                            ...
                            <div class="form-check">
                                ...
                                >
                                <label for="<%=groupHandle%>[<%=counter%>][imageThumbnailCrop]" class="form-check-label"><?= t('Yes'); ?></label>
                            </div>
                        </div>
                        <div class="col-lg-2 mb-4">
                            ...
                            <div class="form-check">
                                ...
                                >
                                <label for="<%=groupHandle%>[<%=counter%>][imageThumbnailEditable]" class="form-check-label"><?= t('Yes'); ?></label>
                            </div>
                        </div>
                    </div>
                    <div class="form-check">
                    ...
                    <div class="col-lg-4 mb-4 <% if (error['imageFullscreenHeight']!=undefined) { %>has-error<% } %>">
                        <label for="<%=groupHandle%>[<%=counter%>][imageFullscreenHeight]" class="form-label"><?= t('Height'); ?></label>
                        <div class="input-group">
                            <input type="text"
                    ...
                    <div class="col-lg-2 mb-4">
                        ...
                        <div class="form-check">
                            ...
                            >
                            <label for="<%=groupHandle%>[<%=counter%>][imageFullscreenCrop]" class="form-check-label"><?= t('Yes'); ?></label>
                        </div>
                    </div>
                    <div class="col-lg-2 mb-4">
                        <label class="form-label"><?= t('Editable'); ?></label>
                        <div class="form-check">
                            ...
                            >
                            <label for="<%=groupHandle%>[<%=counter%>][imageFullscreenEditable]" class="form-check-label"><?= t('Yes'); ?></label>
                        </div>
                    </div>
                </div>
                <% } %>
                ...
                <div class="<% if (error['expressHandle']!=undefined) { %>has-error<% } %>">
                    <label for="<%=groupHandle%>[<%=counter%>][expressHandle]" class="form-label"><?= t('Express object handle'); ?> *</label>
                ...
                <div class="<% if (error['fileSetPrefix']!=undefined) { %>has-error<% } %>">
                    <label for="<%=groupHandle%>[<%=counter%>][fileSetPrefix]" class="form-label"><?= t('Restrict File Set selection to those starting with:'); ?></label>
                ...
                <div class="<% if (error['datePickerPattern']!=undefined) { %>has-error<% } %>">
                    <label for="<%=groupHandle%>[<%=counter%>][datePickerPattern]" class="form-label"><?= t('PHP Date Pattern'); ?></label>
                    <input type="text"
